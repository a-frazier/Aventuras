...
>
  ...
  <div class="w-full max-w-2xl flex justify-center">
    {#if step === "interface"}
      ...
      >
        <Card.Root
          class="w-full text-left backdrop-blur-sm bg-card/95 border-border shadow-2xl"
        >
          <Card.Content class="p-6 space-y-6">
            ...
            <div class="space-y-3">
              ...
              <div class="grid grid-cols-3 gap-2">
                {#each ["small", "medium", "large"] as size}
                  <Button
                    variant={settings.uiSettings.fontSize === size
                      ? "default"
                      : "outline"}
            ...
            <div class="space-y-4 pt-4 border-t border-border">
              ...
              {#if settings.translationSettings.enabled}
                <div
                  class="space-y-4 rounded-xl bg-muted/50 p-4"
                  transition:slide={{ duration: 200, axis: "y" }}
                >
                  <div class="space-y-2">
                    <Label for="lang-select" class="text-sm"
      ...
      >
        <div class="grid w-full grid-cols-1 gap-4 sm:grid-cols-3">
          {#each providers as provider}
            ...
            >
              <div
                class="rounded-full bg-muted p-4 ring-1 ring-background transition-colors group-hover:bg-background"
              >
    ...
    {:else}
      ...
      {#if provider}
        ...
        >
          <Card.Root
            class="w-full backdrop-blur-sm bg-card/95 border-border shadow-2xl"
          >
            <Card.Header>
            ...
            <Card.Content class="space-y-4 text-left">
              ...
              {#if provider.note}
                <div
                  class="rounded-lg bg-muted p-3 text-xs text-muted-foreground"
                >
              ...
              <Button
                ...
                disabled={(provider.requiresKey && !apiKey.trim()) ||
                  isSubmitting}
              >
                {#if isSubmitting}
                  <div
                    class="mr-2 h-4 w-4 animate-spin rounded-full border-2 border-primary-foreground/30 border-t-primary-foreground"
                  ></div>
                  Setting up...
                {:else}
